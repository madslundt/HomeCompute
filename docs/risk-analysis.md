...
| R-037 | Discord voice is assumed full duplex or compatible with every selected STT runtime when the current path pauses during TTS and expects Whisper providers | Unusable conversation, missed speech or hidden adapter scope | 3 | 4 | 12 | Voice last; document half-duplex baseline; test pause/interruption/Opus/ARM64/code-switch; explicit Hviske/Whisper adapter ownership | 4 | Voice owner; V-PA-005 |
